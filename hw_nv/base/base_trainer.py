...
class BaseTrainer:
    ...
    def __init__(self, model: BaseModel, g_criterion, d_criterion, g_optimizer, d_optimizer, config, device):
        self.device = device
        self.config = config
    ...
    def _resume_checkpoint(self, resume_path):
        ...
        if (
                ...
                checkpoint["config"]["lr_g_scheduler"] != self.config["lr_g_scheduler"] or
                checkpoint["config"]["d_optimizer"] != self.config["d_optimizer"] or
                checkpoint["config"]["lr_d_scheduler"] != self.config["lr_d_scheduler"]
